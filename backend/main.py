...
from routes import auth, user, celdas, maquinas, fallas, mantenimiento, tiposTrabajador, empleados, estatusMaquina, usuarios
...
app.include_router(estatusMaquina.router, prefix="/estatusMaquina")
